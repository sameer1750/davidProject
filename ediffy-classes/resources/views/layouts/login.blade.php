...
<head>
    ...
    <!-- iCheck -->
    <link href="{{env('APP_URL')}}/bower_components/admin-lte/plugins/iCheck/square/red.css" rel="stylesheet" type="text/css"/>
...
<!-- iCheck -->
<script src="{{env('APP_URL')}}/bower_components/admin-lte/plugins/iCheck/icheck.min.js" type="text/javascript"></script>
<script>
    $(function () {
        $('input').iCheck({
